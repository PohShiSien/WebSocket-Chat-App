...
public class ClientGUI extends JFrame implements MessageListener {
    ...
    private void addConnectedUsersComponents() {
        ...
        connectedUsersPanel.setBackground(Utilities.SECONDRY_COLOR);
    ...
    private void addChatComponents() {
        ...
        inputField.setBackground(Utilities.SECONDRY_COLOR);
    ...
    public void onActiveUsersUpdated(ArrayList<String> users) {
        ...
        // The user list panel does not get added until after and this is mainly for when the users get updated
