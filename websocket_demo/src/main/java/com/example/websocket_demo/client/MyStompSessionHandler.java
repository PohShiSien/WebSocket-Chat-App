...
public class MyStompSessionHandler extends StompSessionHandlerAdapter {
    ...
    @Override
    public void afterConnected(StompSession session, StompHeaders connectedHeaders) { // No need for @Autowired as StompSession and StompHeaders are runtime objects
        ...
        session.send("/app/requests-users", "");
    }
